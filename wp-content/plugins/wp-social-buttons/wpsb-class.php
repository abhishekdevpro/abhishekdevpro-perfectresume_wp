...
$wpSocialShareContent.='<div id="wpsb-delaydiv">';
$wpSocialShareContent .='<div class="wpsb-social-widget" '.$idName.' title="Share This Site With Your Friends" '.$style.' >';
$wpSocialShareContent .='<div class="wpsb-show"><a href="javascript:" title="Show Buttons" id="wpsb-show"><img src="'.plugins_url('wp-social-buttons/images/'.$showImg).'" alt="Show Buttons"></a></div>';
$wpSocialShareContent.='<div id="wpsb-social-inner">';
...
$wpSocialShareContent .='<div class="sbutton"><div id="tumbr"><a class="tumblr-share-button" href="'.$shareurl.'"></a>
<script id="tumblr-js" async src="//assets.tumblr.com/share-button.js"></script></div></div>';
endif;

if($pluginOptionsVal['wpsb_twitterpublishBtn']!=''):
$wpSocialShareContent .='<div class="sbutton"><div id="twitter"><a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-show-count="false">Tweet</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></div></div>';
endif;

$wpSocialShareContent.='</div>';
$wpSocialShareContent.='<div class="wpsb-hide"><a href="javascript:" title="Hide WP Social Buttons" id="wpsb-hide"><img src="'.plugins_url('wp-social-buttons/images/'.$hideImg).'" alt="Hide Buttons"></a></div></div></div>';
